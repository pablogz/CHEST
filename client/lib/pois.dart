                                  ...
                                  if (snapshot.hasData && !snapshot.hasError) {
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        String comment = task.commentLang(
                                                MyApp.currentLang) ??
                                            task.commentLang('es') ??
                                            task.commentLang('')!;
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute<void>(
                          builder: (BuildContext context) => FormPOI(POI.point(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    initialValue: 'https://gsic.uva.es/', //TODO
                    validator: (v) {
                      if (v != null && v.isNotEmpty) {
                        if (v.trim().isEmpty) {
                          ...
                          //TODO Uri.parse(v.trim()).isAbsolute (para saber si es URL)
                          return null;
                        }
                      } else {
                        return null;
